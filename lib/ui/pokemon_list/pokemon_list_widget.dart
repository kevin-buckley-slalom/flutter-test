...
class PokemonListWidget extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PokemonListWidget> createState() => _PokemonListWidgetState();
}
...
class _PokemonListWidgetState extends ConsumerState<PokemonListWidget> {
  ...
  String _searchQuery = '';
  String _sortField =
      'number'; // 'number', 'name', 'bst', 'hp', 'attack', 'defense', 'spAtk', 'spDef', 'speed'
          ...
          children: [
            ...
            Expanded(
              child: sortedList.isEmpty
                  ...
                  : Scrollbar(
                      thickness:
                          16, // Even thicker scrollbar for mobile visibility
